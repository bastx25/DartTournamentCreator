...
{
    /// <inheritdoc />
    public partial class renameRoundToBraket : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BraketId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupPlayers_GroupId_TournamentPlayerId",
                table: "GroupPlayers",
                columns: new[] { "GroupId", "TournamentPlayerId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GroupPlayers_TournamentPlayerId",
                table: "GroupPlayers",
            ...
            migrationBuilder.CreateIndex(
                ...
                columns: new[] { "MatchId", "TournamentPlayerId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MatchParticipants_TournamentPlayerId",
                table: "MatchParticipants",
                column: "TournamentPlayerId");
